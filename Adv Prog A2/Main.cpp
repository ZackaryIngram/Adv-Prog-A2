...
int main()
{
	...
	cout << "\nEnter 'Begin Game' when you are ready to start !" << endl << endl;
	getline(cin, startGame);
	
	//Start game
	if (startGame == "Begin Game")
	{
		...
		if (survive == false)
		{
			cout << "You sustained too many injuries due to many bad choices, you have failed the zombie simulator. Thank you for playing!" << endl;
		}
		else if (survive == true)
		{
			cout << "You survived the zombie simulator. Thank you for playing!" << endl;
		}
		else
		{
			cout << "Error" << endl;
		...
		cout << "You made " << badChoices << " bad choices out of 4 rooms. " << endl; //Just prints out how many bad choices the user made
	}
